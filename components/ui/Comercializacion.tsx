...
export const Comercializacion = () => {
  return (
    ...
    <Image src="https://res.cloudinary.com/dnxxkvpiz/image/upload/v1663600281/VAYASA/comercializacion_y5zz7z.jpg" alt="oil and gas" style={{ height:"300px", width:"100%", objectFit:'cover' }} />
